...
RUN find /usr/local/lib/python3.11/site-packages/streamlit/static/ -name index.html | xargs sed -i 's|<head>|<head><script async src="https://www.googletagmanager.com/gtag/js?id=G-4WVG826P17"></script><script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag("js", new Date()); gtag("config", "G-4WVG826P17");</script>|'
